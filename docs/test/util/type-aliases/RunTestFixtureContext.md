...
[babel-plugin-metadata-accumulator](../../../README.md) / [test/util](../README.md) / RunTestFixtureContext
...
Defined in: node\_modules/@-xun/test-mock-fixture/dist/packages/test-mock-fixture/src/fixtures/run-test.d.ts:35
